                ...
                <div class="col-lg-12">
                    <div class="card shadow">
                        <div class="card-header  d-flex justify-content-between align-items-center"
                            style="background: rgb(121, 112, 236)">
                            <h3 class="text-light">Manage Employees</h3>

                                <input style="width: 20% ; " type="search"  id="" value="" class="form-control" placeholder="Search by name or email">
                                <button style="margin-right: 200px"   class="btn btn-success">Search</button>
