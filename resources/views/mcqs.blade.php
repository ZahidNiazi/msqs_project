                            ...
                            <ul class="navbar-nav" style="font-weight: bold;">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <li><a class="dropdown-item" style="font-family: Calibri,Candara,Segoe,Segoe UI,Optima,Arial,sans-serif;" href="{{url('/all-mcqs/'.$category->id)}}">{{$category->name}}</a></li>
                                        @endforeach
                                    </ul>
                                </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-8 col-lg-8 mb-5" style="border-left: 1px solid #e9e9e9;">
                    ...
                    <span style=" text:bold; text-align: center; font-family: Calibri,Candara,Segoe,Segoe UI,Optima,Arial,sans-serif; font-weight: bold; font-family: Arial, sans-serif; align-items:justify  ">
                      <p style="text-align: justify;">
                        ...
                        Besides, writing correct English, passing the essay paper requires writing technique, skill, and practice. Most CSS or PMS candidates do not acquire competent guidelines, as a result, their dream not come true to become a bureaucrat.</p>
                    ...
                    <div class="mcqs-heading text-center pt-5">
                        @foreach ($mcqs as $mcq)
                        <h3 style="text-decoration: underline overline;padding-bottom:3px;"><b style="font-family: Calibri,Candara,Segoe,Segoe UI,Optima,Arial,sans-serif;  ">{{$mcq->title}}</b></h3>
                        @endforeach
                    </div>
                    ...
                    <div class="mcqs-section mb-3">
                        ...
                        <div class="mcqs" style="padding-left: 30px;">
                            <span><b style="font-family: Calibri,Candara,Segoe,Segoe UI,Optima,Arial,sans-serif; ">{{$startIndex + $index}}.  {{$mcq->question}}</b></span>
                            ...
                            <div class="collaps-btn">
                                <button class="btn btn-sm" type="button" data-bs-toggle="collapse" data-bs-target="#btn-{{$loop->iteration}}"
                            ...
                            <ul>
                                @foreach ($categories as $category)
                                    <a href="{{url('/all-mcqs/'.$category->id)}}">
                                        <li style="font-family: 'Alatsi', sans-serif;"><i class="fa-solid fa-circle-arrow-right"></i> &nbsp {{$category->name}}  <img src="{{ asset('web-assets//img/ZJtB.gif') }}" alt="blink-img"></li>
