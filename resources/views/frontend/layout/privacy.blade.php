        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-8 col-lg-8 mb-5" style="border-left: 1px solid #e9e9e9;">
                <div class="mcqs-heading text-center">
                    <h3 style="padding-top: 20px; ">Privacy Policy</h3>
                    <p style="text-align: justify; padding-top: 20px; padding:20px; font-family: sans-serif;" >
                        

    At <strong>McqsLogic</strong>, we are committed to ensuring the privacy and security of your personal information. This Privacy Policy outlines how we collect, use, and protect your information when you use our website. By accessing and using McqsLogic, you agree to the terms of this Privacy Policy.

    Information We Collect
  <br>
   <strong>Personal Information: </strong> We may collect personally identifiable information, such as your name, email address, and contact details. This information is collected when you voluntarily submit it to us, such as when you register for an account, subscribe to our newsletter, or contact us.

    Usage Data: We may collect information about how you interact with our website, including the pages you visit, the links you click, and other actions you take while using the website. This data is collected using cookies and similar technologies.
<br>
   <strong>How We Use Your Information </strong>

    We use your personal information to provide and improve our services, respond to your inquiries, and communicate with you about updates and promotions.
    Usage data helps us analyze and enhance the performance of our website, improve user experience, and develop new features.
    Cookies and Tracking Technologies

    We use cookies and similar tracking technologies to gather information about your interactions with our website. These technologies help us provide you with a better user experience and personalized content.
   <br>
    <strong>Third-Party Services </strong>

    We may use third-party services to collect, monitor, and analyze usage data. These services may use cookies and similar technologies to track your interactions with our website.
    <br>
    <strong>Data Security</strong> 

    We take appropriate measures to protect your personal information from unauthorized access, alteration, disclosure, or destruction. However, no data transmission over the internet or electronic storage method is completely secure, and we cannot guarantee the absolute security of your data.
                    </p>
                </div>
