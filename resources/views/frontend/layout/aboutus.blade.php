        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-8 col-lg-8 mb-5" style="border-left: 1px solid #e9e9e9;">
                <div class="mcqs-heading text-center">
                    <h3 style="padding-top: 20px; ">Abouts Us</h3>
                    <p style="text-align: justify; padding-top: 20px; padding:20px; font-family: sans-serif;" >
                        McqsLogic.com is an online portal that provides a wide range of multiple-choice questions and
                        preparatory assessments for individuals aspiring to secure jobs in government or private organizations.
                        Our platform boasts an extensive repository of frequently asked MCQs, sourced from various assessments and generously contributed by our members.
                        <br><br>
                
                        At McqsLogic, we have swiftly emerged as the most visited and trusted website in the field of test preparation in our region.
                         With over 1 million monthly users, we have become the go-to platform for individuals seeking comprehensive exam preparation resources.
                         <br><br>
                
                        We pride ourselves on offering a comprehensive coverage of topics, ensuring that our users have access to a complete and
                        effective preparation platform for their competitive exams. Our multiple-choice questions are presented in a user-friendly format,
                        facilitating easy comprehension and efficient practice. Furthermore, we encourage collaborative learning by enabling users to comment on
                        and discuss each question with fellow learners. We strive to maintain an up-to-date question bank, with a significant portion of our MCQs
                         collected from recent tests.
                         <br><br>
                
                        We value the contributions of our users in making McqsLogic a valuable resource. Therefore, we wholeheartedly welcome your
                        participation in enhancing our platform's effectiveness and usefulness. If you have any multiple-choice questions to contribute
                        or any queries or suggestions, please do not hesitate to contact us via email at <strong>aziz0346@gmail.com</strong>.
                        <br><br>
                
                       <strong>Thank you for your support in making McqsLogic.com a trusted destination for test preparation.</strong>
                    </p>
                </div>
