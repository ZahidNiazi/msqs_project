            ...
            <div class="col-12 mb-4">
              <article class="card article-card">
                ...
                <div class="card-body px-0 pb-1">
                  ...
                  <h2 class="h1"><a class="post-title" href="{{ route('article') }}">Is it Ethical to Travel Now?
                  ...
                  <div class="content"> <a class="read-more-btn" href="{{ route('article') }}">Read Full Article</a>
                  </div>
                </div>
              </article>
            </div>
